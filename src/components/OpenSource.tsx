...
export default function OpenSource() {
  return (
    <section id="open-source" className="mb-24 animate-fadeIn scroll-mt-32 md:scroll-mt-40" style={{ animationDelay: "320ms", animationFillMode: "both" }}>
      ...
      <article className="border border-white/10 bg-white/[0.03] p-6 transition duration-200 hover:-translate-y-1 hover:border-pink-400/40 md:p-8">
          ...
          <div className="grid gap-3">
            {highlights.map(({ label, value, icon: Icon }) => (
              <div key={label} className="flex items-center gap-4 border border-white/10 bg-zinc-950 p-4">
                <div className="flex size-10 shrink-0 items-center justify-center border border-white/10 text-pink-300">
